  /*
  Pizza maker converted to food item maker.
  */

  var menuItemIngredients = {};
  menuItemIngredients.meats = [
    "Pepperoni",
    "Sausage",
    "Fennel Sausage",
    "Spicy Sausage",
  ...
  function generator(adj, noun, type) {
    ...
    var name = "The " + adjectives[randomAdjective].capitalize() + " " + nouns[randomNoun].capitalize()  + " " + type;
    return name;
  };
  ...
  function randomName(type) {
    ...
    return generator(adjectives[randomNumberAdj], nouns[randomNumberNoun], type);
  };

  // These functions return a string of a random ingredient from each respective category of ingredients.
  var selectRandomMeat = function() {
    var randomMeat = menuItemIngredients.meats[Math.floor((Math.random() * menuItemIngredients.meats.length))];
    return randomMeat;
  }

  var selectRandomNonMeat = function() {
    var randomNonMeat = menuItemIngredients.nonMeats[Math.floor((Math.random() * menuItemIngredients.nonMeats.length))];
    return randomNonMeat;
  }

  var selectRandomCheese = function() {
    var randomCheese = menuItemIngredients.cheeses[Math.floor((Math.random() * menuItemIngredients.cheeses.length))];
    return randomCheese;
  }

  var selectRandomSauce = function() {
    var randomSauce = menuItemIngredients.sauces[Math.floor((Math.random() * menuItemIngredients.sauces.length))];
    return randomSauce;
  }

  var selectRandomCrust = function() {
    var randomCrust = menuItemIngredients.crusts[Math.floor((Math.random() * menuItemIngredients.crusts.length))];
    return randomCrust;
  }
  ...
  var makeRandomMenuItem = function(type) {
    ...
    for (var i = 0; i < numberOfMeats; i++) {
      MenuItem.ingredients.push(selectRandomMeat());
    }

    for (var i = 0; i < numberOfNonMeats; i++) {
      MenuItem.ingredients.push(selectRandomNonMeat());
    }

    for (var i = 0; i < numberOfCheeses; i++) {
      MenuItem.ingredients.push(selectRandomCheese());
    }
