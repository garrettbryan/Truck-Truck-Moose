...
/*
initialize user by checking if the session is continuing and if the data is relevant, then reload the last session data. If the data is stale then reinitialize the foodtrucks, meetup, and weather data.
*/
